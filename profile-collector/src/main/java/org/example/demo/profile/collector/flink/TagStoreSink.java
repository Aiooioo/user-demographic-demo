...
public class TagStoreSink extends RichSinkFunction<Tuple2<String, Long>> {
    private final ProfileStoreFactory factory;
    private final String field;
    private transient ProfileStore store;

    public TagStoreSink(ProfileStoreFactory factory, String field) {
    ...
    public void invoke(Tuple2<String, Long> value, Context context) {
        store.setTag(value.f0, field, String.valueOf(value.f1));
    }
